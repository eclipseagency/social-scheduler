      ...
      <section className="py-20 md:py-32 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-[#94a3b8] max-w-3xl mx-auto mb-10 animate-fade-in">
            Streamline your social media workflow with AI-generated captions,
            smart scheduling, and seamless multi-platform publishing for
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="glass-card p-6 animate-pulse-glow">
                  ...
                  <div className="h-40 bg-[rgba(139,92,246,0.1)] rounded-lg mb-4" />
